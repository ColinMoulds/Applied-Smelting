...
public final class ModBlockEntities {
    ...
    public static final Supplier<BlockEntityType<MESmelterBlockEntity>> ME_SMELTER =
            REGISTER.register("me_smelter", () -> {
    ...
    public static final Supplier<BlockEntityType<MEBlastFurnaceBlockEntity>> ME_BLAST_FURNACE =
            REGISTER.register("me_blast_furnace", () -> {
    ...
    public static final Supplier<BlockEntityType<MESmokerBlockEntity>> ME_SMOKER =
            REGISTER.register("me_smoker", () -> {
    ...
    public static final Supplier<BlockEntityType<MECrucibleBlockEntity>> ME_CRUCIBLE =
            REGISTER.register("me_crucible", () -> {
    ...
    public static final Supplier<BlockEntityType<SmeltingTerminalBlockEntity>> SMELTING_TERMINAL =
            REGISTER.register("me_smelting_terminal", () -> {
                ...
                reference.set(type);
                ModBlocks.SMELTING_TERMINAL.get().setBlockEntity(SmeltingTerminalBlockEntity.class, type, null, null);
                return type;
            });
