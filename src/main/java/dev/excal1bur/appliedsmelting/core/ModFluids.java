...
public final class ModFluids {
    ...
    public static final Supplier<Fluid> MOLTEN_IRON = FLUIDS.register(
            "molten_iron",
            () -> new BaseFlowingFluid.Source(new BaseFlowingFluid.Properties(
                    MOLTEN_IRON_TYPE, ModFluids.MOLTEN_IRON, ModFluids.MOLTEN_IRON_FLOWING)));
    public static final Supplier<Fluid> MOLTEN_IRON_FLOWING = FLUIDS.register(
            "molten_iron_flowing",
    ...
    public static final Supplier<Fluid> MOLTEN_COPPER = FLUIDS.register(
            "molten_copper",
            () -> new BaseFlowingFluid.Source(new BaseFlowingFluid.Properties(
                    MOLTEN_COPPER_TYPE, ModFluids.MOLTEN_COPPER, ModFluids.MOLTEN_COPPER_FLOWING)));
    public static final Supplier<Fluid> MOLTEN_COPPER_FLOWING = FLUIDS.register(
            "molten_copper_flowing",
            () -> new BaseFlowingFluid.Flowing(new BaseFlowingFluid.Properties(
                    MOLTEN_COPPER_TYPE, ModFluids.MOLTEN_COPPER, ModFluids.MOLTEN_COPPER_FLOWING)));

    public static final Supplier<FluidType> MOLTEN_GOLD_TYPE = fluidType("molten_gold");
    public static final Supplier<Fluid> MOLTEN_GOLD = FLUIDS.register(
            "molten_gold",
            () -> new BaseFlowingFluid.Source(new BaseFlowingFluid.Properties(
                    MOLTEN_GOLD_TYPE, ModFluids.MOLTEN_GOLD, ModFluids.MOLTEN_GOLD_FLOWING)));
    public static final Supplier<Fluid> MOLTEN_GOLD_FLOWING = FLUIDS.register(
            "molten_gold_flowing",
            () -> new BaseFlowingFluid.Flowing(new BaseFlowingFluid.Properties(
                    MOLTEN_GOLD_TYPE, ModFluids.MOLTEN_GOLD, ModFluids.MOLTEN_GOLD_FLOWING)));
