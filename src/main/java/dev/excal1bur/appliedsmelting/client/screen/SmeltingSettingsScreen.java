...
public final class SmeltingSettingsScreen extends AESubScreen<SmeltingTerminalMenu, SmeltingTerminalScreen> {
    ...
    public SmeltingSettingsScreen(SmeltingTerminalScreen parent) {
        ...
        var backButton = new TabButton(
                Icon.BACK, Component.translatable("gui.appliedsmelting.back_to_terminal"), button -> closeSettings());
        widgets.add("back", backButton);

        powerButton =
                new ToggleButton(Icon.REDSTONE_ON, Icon.REDSTONE_OFF, enabled -> menu.requestNetworkEnabled(enabled));
    ...
    protected void updateBeforeRender() {
        ...
        setTextContent(
                "network_idle",
                Component.translatable("gui.appliedsmelting.network_idle_ae", menu.combinedIdleAeTimes100 / 100.0));
        setTextContent(
                "network_ae_fuel",
                Component.translatable("gui.appliedsmelting.network_ae_fuel", menu.combinedAeFuelTimes100 / 100.0));
    }
